...
CREATE TABLE tbl_borrower (
    borrower_CardNo INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE tbl_book_copies (
    book_copies_CopiesID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE tbl_book_loans (
    book_loans_LoansID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
